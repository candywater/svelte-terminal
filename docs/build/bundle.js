...
visit https://github.com/candywater/svelte-terminal/ for more info. `;
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(82:4) {#if minimize_terminal === false}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function onLoad() {
    		...
    		if (!exactClose) $$invalidate(12, exactClose = () => {
    	...
    	const writable_props = ["title", "commands", "exactClose", "fontsize", "fontfamily"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("exactClose" in $$props) $$invalidate(12, exactClose = $$props.exactClose);
    		if ("fontsize" in $$props) $$invalidate(13, fontsize = $$props.fontsize);
    		if ("fontfamily" in $$props) $$invalidate(14, fontfamily = $$props.fontfamily);
    	};
    ...
    class Terminal extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*exactClose*/ ctx[12] === undefined && !("exactClose" in props)) {
    			console.warn("<Terminal> was created without expected prop 'exactClose'");
    		}

    		if (/*fontsize*/ ctx[13] === undefined && !("fontsize" in props)) {
    			console.warn("<Terminal> was created without expected prop 'fontsize'");
    		}

    		if (/*fontfamily*/ ctx[14] === undefined && !("fontfamily" in props)) {
